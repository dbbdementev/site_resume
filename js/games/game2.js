...
button_start.onclick = function() {
    var n = $("#count").val(); //Количество фигур
    var line_width=$("#line_width").val(); //  Ширина линии
    var radius = $("#radius").val(); // Радиус углов
    var time_color = $("#time_color").val()*500;//Скорость изменения цветов
